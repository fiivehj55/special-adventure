...
drop table QUESTION;
 ...
 LOB ("MEM_IMG") STORE AS BASICFILE (
  ...
  CREATE TABLE "POJO"."CUSTOMER_DETAIL" 
   (	"CUS_ID" VARCHAR2(20 BYTE) NOT NULL ENABLE, 
	 CONSTRAINT "CUSTOMER_DETEAIL_PK" PRIMARY KEY ("CUS_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE
  ...
  CREATE TABLE "POJO"."REGISTER_DETAIL" 
   (	"REGIST_ID" VARCHAR2(20 BYTE) NOT NULL ENABLE, 
	 CONSTRAINT "REGISTER_DETAIL_PK" PRIMARY KEY ("REGIST_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE
  ...
  CREATE TABLE "POJO"."ADMIN_DETAIL" 
   (	"ADMIN_ID" VARCHAR2(20 BYTE) NOT NULL ENABLE, 
	 CONSTRAINT "ADMINISTRATOR_DETAIL_PK" PRIMARY KEY ("ADMIN_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE
...
insert into CUSTOMER_DETAIL values ('hong');
insert into REGISTER_DETAIL values ('jang');
insert into ADMIN_DETAIL values ('admin');
